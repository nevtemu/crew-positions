...
function aircraftSelector (input){
    ...
    const fleet = {
        ...
        HB3: {reg: ['BJ','BK','BM','GD','GG','GK','GP','GT','GU','GW','GJ','GL','GM','GN','GO','GQ','GR','GS','GV','GX','GY','GZ','NE','NG','NJ','NK','NL','NM','NN','NP','NQ','NR','NS','NT','NU','NV','NX','NZ','PA','PB','PC','PD','PF','PH','PI','PJ','PK','PL','PM','PN','PO','PP','PS','PU'], description: "B773 3 class (Hard blocked seats)", crc: -1, planeType: "B773", classes: 3},
        //A380 
